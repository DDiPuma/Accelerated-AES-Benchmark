...
void InvSubBytes(block_vector_t* const p_state);
void InvShiftRows(block_vector_t* const p_state);
void InvMixColumns(block_vector_t* const p_state);
void InvAesCipher128(const block_vector_t* const p_input,
                     block_vector_t* const p_output,
                     const key_schedule_t* const p_key_sched);
