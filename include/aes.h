 ...
 *  is replaced by a lookup table for performance.
 *  This is used in the naive CPU implementation.
 *  aes_cpu.h has GFMul() which uses an actual multiplication algorithm.
 *  It is only used in generate_multiplication_tables.c to create the
 *  tables below.
 */

#ifndef AES_CL
const uint8_t GFMulBy2[256] = {
#else
__constant uint8_t GFMulBy2[256] = {
#endif
...
#ifndef AES_CL
const uint8_t GFMulBy3[256] = {
#else
__constant uint8_t GFMulBy3[256] = {
#endif
